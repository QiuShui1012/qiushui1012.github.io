...
* 除非另有说明，否则代码默认许可为 [LICENSE 文件(LGPL-3.0)](https://github.com/QiuShui1012/AnvilCraft-VoidInAir/LICENSE)
* 除非另有说明，否则非代码资产默认许可为 [ASSET_LICENSE 文件(ARR)](https://github.com/QiuShui1012/AnvilCraft-VoidInAir/ASSETS_LICENSE)
